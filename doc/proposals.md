...
![Proposals window](img/fixmt-proposals-window.png)
...
![Column selection dialog](img/fixmt-proposals-columns.png)
 ...
 * A chart summarizing YES, NO and ABSTAIN vote counts.  
    ![Voting history tab](img/fixmt-proposals-voting-history.png)  

    Vote change chart:  
    ![Vote change chart](img/fixmt-proposals-vote-change-chart.png)  

    Vote summary chart:  
    ![Vote summary chart](img/fixmt-proposals-vote-summary-chart.png)
...
![Vote tab](img/fixmt-proposals-vote-2.png)
