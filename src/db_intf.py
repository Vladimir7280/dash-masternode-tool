...
log = logging.getLogger('fixmt.db_intf')
    ...
    def create_structures(self):
        try:
            ...
            cur.execute("CREATE TABLE IF NOT EXISTS masternodes(id INTEGER PRIMARY KEY, ident TEXT, status TEXT,"
                        ...
                        " fixmt_active INTEGER, fixmt_create_time TEXT, fixmt_deactivation_time TEXT)")

            cur.execute("CREATE INDEX IF NOT EXISTS IDX_masternodes_DMT_ACTIVE ON masternodes(fixmt_active)")
            ...
            cur.execute("CREATE TABLE IF NOT EXISTS proposals(id INTEGER PRIMARY KEY, name TEXT, payment_start TEXT,"
                        ...
                        " f_cached_endorsed INTEGER, object_type INTEGER, is_valid_reason TEXT, fixmt_active INTEGER, "
                        " fixmt_create_time TEXT, fixmt_deactivation_time TEXT, fixmt_voting_last_read_time INTEGER,"
            ...
            # has just been sent from fixmt wallet or the transaction which appeared in the mempool); in this case
