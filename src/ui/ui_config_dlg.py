...
# Form implementation generated from reading ui file '/Users/blogin/PycharmProjects/FIXMT-git/src/ui/ui_config_dlg.ui'
#
...
class Ui_ConfigDlg(object):
    def setupUi(self, ConfigDlg):
        ...
        self.tabFixd = QtWidgets.QWidget()
        self.tabFixd.setObjectName("tabFixd")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.tabFixd)
        self.verticalLayout_3.setContentsMargins(3, 3, 3, 3)
        self.verticalLayout_3.setSpacing(3)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.label_2 = QtWidgets.QLabel(self.tabFixd)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_3.addWidget(self.label_2)
        self.cboFixNetwork = QtWidgets.QComboBox(self.tabFixd)
        self.cboFixNetwork.setObjectName("cboFixNetwork")
        self.cboFixNetwork.addItem("")
        self.cboFixNetwork.addItem("")
        self.horizontalLayout_3.addWidget(self.cboFixNetwork)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem)
        self.verticalLayout_3.addLayout(self.horizontalLayout_3)
        self.frame_2 = QtWidgets.QFrame(self.tabFixd)
        ...
        self.tabWidget.addTab(self.tabFixd, "")
    ...
    def retranslateUi(self, ConfigDlg):
        ...
        self.label_2.setText(_translate("ConfigDlg", "FIX network:"))
        self.cboFixNetwork.setItemText(0, _translate("ConfigDlg", "MAINNET"))
        self.cboFixNetwork.setItemText(1, _translate("ConfigDlg", "TESTNET"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabFixd), _translate("ConfigDlg", "FIX network"))
        ...
        self.chbDownloadProposalExternalData.setText(_translate("ConfigDlg", "Download external proposal attributes (FixCentral.org)"))
